...
4. Open the feed.php file in a web browser (http://YOURURLHERE.indiana.edu/_php/twitter/feed.php). This should return the initial JSON feed and set the cache.
